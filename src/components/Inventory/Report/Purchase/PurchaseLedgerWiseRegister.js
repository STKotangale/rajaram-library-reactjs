...
const PurchaseLedgerWiseRegister = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${BaseURL}/api/reports/purchaseRegisterLedgerWiseDateWise`, {
                method: 'POST',
                headers: {
        ...
        <div className='member-report'>
            ...
            <Modal show={showModal} onHide={handleCloseModal} size="xl">
                <Modal.Header closeButton>
                    <Modal.Title className="flex-grow-1">Purchase Register Date Wise</Modal.Title>
...
export default PurchaseLedgerWiseRegister;
