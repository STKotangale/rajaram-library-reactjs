...
const IssueReturnRegisterMemberWise = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`${BaseURL}/api/reports/issue-return-member-wise`, {
                method: 'POST',
                headers: {
        ...
        <div className='member-report'>
                ...
                <div className="centered-form">
                    <Container>
                        <div className="form-header">
                            <h2>Issue Return Member Wise Register</h2>
                        </div>
            ...
            <Modal show={showModal} onHide={handleCloseModal} size="xl">
                <Modal.Header closeButton>
                    <Modal.Title className="flex-grow-1">Issue Return Member Wise Report</Modal.Title>
...
export default IssueReturnRegisterMemberWise;
