...
const IssueReturnRegister = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`${BaseURL}/api/reports/issueReturnRegisterDateWise`, {
                method: 'POST',
                headers: {
        ...
        <div className='member-report'>
            ...
            <Modal show={showModal} onHide={handleCloseModal} size="xl">
                <Modal.Header closeButton>
                    <Modal.Title className="flex-grow-1">Issue Return Register Date Wise</Modal.Title>
...
export default IssueReturnRegister;
