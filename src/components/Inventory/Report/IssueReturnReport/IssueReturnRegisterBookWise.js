...
const IssueReturnRegisterBookWise = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`${BaseURL}/api/reports/issue-return-book-wise`, {
                method: 'POST',
                headers: {
        ...
        <div className='member-report'>
                ...
                <div className="centered-form">
                    <Container>
                        <div className="form-header">
                            <h2>Issue Return Book Wise Register</h2>
                        </div>
            ...
            <Modal show={showModal} onHide={handleCloseModal} size="xl">
                <Modal.Header closeButton>
                    <Modal.Title className="flex-grow-1">Issue Return Book Wise Report</Modal.Title>
...
export default IssueReturnRegisterBookWise;
