...
const PurchaseReturnRegister = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`${BaseURL}/api/reports/purchaseReturnRegisterDateWise`, {
                method: 'POST',
                headers: {
        ...
        <div className='member-report'>
                ...
                <div className="centered-form">
                    <Container>
                        <div className="form-header">
                            <h2>Purchase Return Register</h2>
                        </div>
            ...
            <Modal show={showModal} onHide={handleCloseModal} size="xl">
                <Modal.Header closeButton>
                    <Modal.Title className="flex-grow-1">Purchase Return Register Date Wise</Modal.Title>
