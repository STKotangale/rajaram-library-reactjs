...
const BookLostRegister = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`${BaseURL}/api/reports/bookLostRegisterDateWise`, {
                method: 'POST',
                headers: {
        ...
        <div className='member-report'>
            ...
            <Modal show={showModal} onHide={handleCloseModal} size="xl">
                <Modal.Header closeButton>
                    <Modal.Title className="flex-grow-1">Book Lost Register Date Wise</Modal.Title>
...
export default BookLostRegister;
